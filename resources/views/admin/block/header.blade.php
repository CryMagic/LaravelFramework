            ...
            <ul class="info-menu left-links list-inline list-unstyled">
                ...
                <li class="message-toggle-wrapper">
                    <a href="#" data-toggle="dropdown" class="toggle">
                        ...
                        <span class="badge badge-accent">{{ $countOrderNotRead }}</span>
                    </a>
                    <ul class="dropdown-menu messages animated fadeIn">
                        ...
                        <li class="list">
                            ...
                            <ul class="dropdown-menu-list list-unstyled ps-scrollbar">
                                @foreach($orderNotReads as $item)
                                <li class="unread status-available" >
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{ url('images/user/',$item->belongsToUser->avatar) }}" alt="user-image" class="img-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                                <strong>{{ $item->belongsToUser->firstname }} {{ $item->belongsToUser->lastname }}</strong>
                                                <span class="time small">{{ $item->updated_at->diffForHumans() }}</span>
                ...
                <li class="hidden-sm hidden-xs searchform">
                    <form action="http://jaybabani.com/complete-admin/v4.1/preview/fullmenu/ui-search.html" method="post">
