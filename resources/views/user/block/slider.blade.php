    ...
    <div class="full-container">
        <div class="slider-content">
            ...
            <div class="slider slider-v1" data-cycle-swipe=true data-cycle-prev=".prevControl" data-cycle-next=".nextControl" data-cycle-loader="wait">
                <div class="slider-item slider-item-img1"><img src="{{ url('user/images/slider/slider0.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img">
                </div>
                <div class="slider-item slider-item-img1">
                    ...
                    <img src="{{ url('user/images/slider/slider1.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img">
                </div>
                <div class="slider-item slider-item-img2">
                    ...
                    <img src="{{ url('user/images/slider/slider3.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img">
                </div>
                <div class="slider-item slider-item-img3">
                    ...
                    <img src="{{ url('user/images/slider/slider4.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img">
                </div>
                <div class="slider-item slider-item-img3">
                    <div class="sliderInfo">
                        <div class="container">
                            <div class="col-lg-5 col-md-6 col-sm-5 col-xs-5 pull-left sliderText blankstyle transformRight">
                                <div class="inner text-right"><img src="{{ url('user/images/slider/color.png')}}" class="img-responsive" alt="img"></div>
                            </div>
                    ...
                    <img src="{{ url('user/images/slider/6.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img">
                </div>
            </div>
        </div>
    </div>
