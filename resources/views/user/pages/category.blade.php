                ...
                <div class="panel-group" id="accordionNo">
                        ...
                        <div id="collapseCategory" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked tree">
                                    ...
                                    <li>
                                        <a href="#"> <span class="badge pull-right">42</span> MEN COLLECTION </a>
                                    </li>
                                    <li>
                                        <a href="#"> <span class="badge pull-right">42</span> Baby & Kids </a>
                                    </li>
                                    <li>
                                        <a href="#"> <span class="badge pull-right">42</span> Home & Kitchen </a>
                                    </li>
                                    <li>
                                        <a href="#"> <span class="badge pull-right">42</span> Baby & Kids </a>
                                    </li>
                                    <li>
                                        <a href="#"> <span class="badge pull-right">42</span> More Stores </a>
                                    </li>
                                    <li>
                                        <a href="#"> <span class="badge pull-right">42</span> Offers Zone </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           ...
                           Price <span class="pull-left"> <i class="fa fa-caret-right"></i></span> </a> <span class="pull-right clearFilter  label-danger"> Clear </span>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           ...
                           Brand <span class="pull-left"> <i class="fa fa-caret-right"></i></span> </a>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           ...
                           Color <span class="pull-left"> <i class="fa fa-caret-right"></i></span> </a>
                            </h4>
                        </div>
                ...
                <div class="row subCategoryList clearfix">
                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center ">
                        <div class="thumbnail equalheight">
                            <a class="subCategoryThumb" href="sub-category.html"><img src="{{ url('user/images/product/3.jpg') }}" class="img-rounded " alt="img"> </a> <a class="subCategoryTitle"><span> T shirt </span></a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                        <div class="thumbnail equalheight">
                            <a class="subCategoryThumb" href="sub-category.html"><img src="{{ url('user/images/site/casual.jpg') }}" class="img-rounded " alt="img"> </a> <a class="subCategoryTitle"><span> Shirt </span></a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                        <div class="thumbnail equalheight">
                            <a class="subCategoryThumb" href="sub-category.html"><img src="{{ url('user/images/site/shoe.jpg') }}" class="img-rounded " alt="img"> </a> <a class="subCategoryTitle"><span> shoes </span></a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                        <div class="thumbnail equalheight">
                            <a class="subCategoryThumb" href="sub-category.html"><img src="{{ url('user/images/site/jewelry.jpg') }}" class="img-rounded " alt="img"> </a> <a class="subCategoryTitle"><span> Accessories </span></a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                        <div class="thumbnail equalheight">
                            <a class="subCategoryThumb" href="sub-category.html"><img src="{{ url('user/images/site/winter.jpg') }}" class="img-rounded  " alt="img"> </a> <a class="subCategoryTitle"><span> Winter Collection </span></a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                        <div class="thumbnail equalheight">
                            <a class="subCategoryThumb" href="sub-category.html"><img src="{{ url('user/images/site/Male-Fragrances.jpg') }}" class="img-rounded " alt="img"> </a> <a class="subCategoryTitle"><span> Fragrances </span></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                        <div class="product">
                            ...
                            <div class="image">
                                ...
                                <a href="product-details.html"><img src="{{ url('user/images/product/16.jpg') }}" alt="img" class="img-responsive"></a>
                            </div>
                            <div class="description">
                    ...
                    <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                        <div class="product">
                            ...
                            <div class="image">
                                ...
                                <a href="product-details.html"><img src="{{ url('user/images/product/19.jpg') }}" alt="img" class="img-responsive"></a>
                            </div>
                            <div class="description">
