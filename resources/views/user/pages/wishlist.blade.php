                            ...
                            <tbody>
                                <tr class="CartProduct">
                                    <td style="width:10%" class="CartProductThumb">
                                        <div>
                                            <a href="product-details.html"><img src="{{ url('user/images/product/9.jpg') }}" alt="img"></a>
                                        </div>
                                    </td>
                                    <td style="width:40%">
                                    ...
                                    <td style="width:10%" class="CartProductThumb">
                                        <div>
                                            <a href="product-details.html">
                                                <img src="{{ url('user/images/product/11.jpg') }}" alt="img"></a>
                                        </div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="CartDescription">
                                ...
                                <tr class="CartProduct">
                                    <td style="width:10%" class="CartProductThumb">
                                        <div>
                                            <a href="product-details.html">
                                                <img src="{{ url('user/images/product/a2.jpg') }}" alt="img"></a>
                                        </div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="CartDescription">
                                ...
                                <tr class="CartProduct">
                                    <td style="width:10%" class="CartProductThumb">
                                        <div>
                                            <a href="product-details.html">
                                                <img src="{{ url('user/images/product/a5.jpg') }}" alt="img"></a>
                                        </div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="CartDescription">
                                ...
                                <tr class="CartProduct">
                                    <td style="width:10%" class="CartProductThumb">
                                        <div>
                                            <a href="product-details.html">
                                                <img src="{{ url('user/images/product/a4.jpg') }}" alt="img"></a>
                                        </div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="CartDescription">
                                ...
                                <tr class="CartProduct">
                                    <td style="width:10%" class="CartProductThumb">
                                        <div>
                                            <a href="product-details.html">
                                                <img src="{{ url('user/images/product/a3.jpg') }}" alt="img"></a>
                                        </div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="CartDescription">
